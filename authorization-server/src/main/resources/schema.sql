...
--  now()  + INTERVAL 1 DAY, "b9b14387-25d0-46c8-8406-2c11deff05f0", "client_secret_basic", "refresh_token,authorization_code", "http://127.0.0.1:8082/login/oauth2/code/gateway", 
--  "http://127.0.0.1:8082/logged-out", "openid,profile", 
